...
public enum ObservableProperty {
    ...
    CHUNKS(Type.MULTIPLE_REFERENCE),
    ...
    INLINE_CAST(Type.SINGLE_REFERENCE),
    INNER(Type.SINGLE_REFERENCE),
    INTERFACE(Type.SINGLE_ATTRIBUTE),
    ITEMS(Type.MULTIPLE_REFERENCE),
    ...
    RULE_BODY(Type.SINGLE_REFERENCE),
    SCOPE(Type.SINGLE_REFERENCE),
    SELECTOR(Type.SINGLE_REFERENCE),
    SINGLE_VALUE(Type.SINGLE_ATTRIBUTE),
    ...
    TIME_UNIT(Type.SINGLE_ATTRIBUTE),
