...
public abstract class DrlGenericVisitorWithDefaults<R, A> extends GenericVisitorWithDefaults<R, A> implements DrlGenericVisitor<R, A> {
    ...
    public R visit(RuleDeclaration ruleDeclaration, A arg) {
        return defaultAction(ruleDeclaration, arg);
    }

    public R visit(RuleBody n, A arg) {
        return defaultAction(n, arg);
    }

    public R visit(RulePattern n, A arg) {
        return defaultAction(n, arg);
    }

    public R visit(RuleJoinedPatterns n, A arg) {
        return defaultAction(n, arg);
    }
    ...
    public R visit(OOPathExpr n, A arg) {
        return defaultAction(n, arg);
    }

    public R visit(OOPathChunk n, A arg) {
        return defaultAction(n, arg);
    }

    public R visit(RuleConsequence n, A arg) {
        return defaultAction(n, arg);
    }
    ...
    public R visit(PointFreeExpr n, A arg) {
        return defaultAction(n, arg);
    }
    ...
    public R visit(HalfPointFreeExpr n, A arg) {
        return defaultAction(n, arg);
    }
